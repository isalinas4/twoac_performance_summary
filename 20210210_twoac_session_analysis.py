...
for subject in subjects: 
    ...
    trial_information['choice_bins'] = pd.cut(trial_information.choice_range,
                                             bins=pd.interval_range(start=0, end=1150, periods=5))    
    ...
    #binned_trial_info.plot.bar(y=['hit_outcome', 'total_errors', 'false_alarms'])
    
#This plot shows the trials
    '''    
    ax = binned_trial_info[['hits', 'errors', 'false_alarms']].plot(kind='bar', figsize=(15, 10), legend=True, fontsize=20, color=('purple', 'green', 'orange'))
